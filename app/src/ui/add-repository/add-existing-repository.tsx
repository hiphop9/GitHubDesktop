  ...
  public render() {
    return (
      <Dialog
        ...
        title={tr(__DARWIN__ ? 'Add Local Repository' : 'Add local repository')}
      ...
      >
        <DialogContent>
          <Row>
            ...
            />
            <Button onClick={this.showFilePicker}>{tr('Choose…')}</Button>
          </Row>
          {this.renderErrors()}
        </DialogContent>
        ...
        <DialogFooter>
          <OkCancelButtonGroup
            okButtonText={tr(__DARWIN__ ? 'Add Repository' : 'Add repository')}
          />
        </DialogFooter>
      </Dialog>
    )
